...
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE SCHEMA dblink;'${NC}"
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE EXTENSION dblink SCHEMA dblink;'${NC}"
...
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE SCHEMA profile AUTHORIZATION profile_usr;'${NC}"
echo -e "${CYAN}PGPASSWORD=profile_pwd psql -X -h 127.0.0.1 -U profile_usr -d postgres -c 'CREATE EXTENSION pg_profile SCHEMA profile;'${NC}"
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE SCHEMA pgss;'${NC}"
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE SCHEMA pgsk;'${NC}"
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE SCHEMA pgws;'${NC}"
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE EXTENSION pg_stat_statements SCHEMA pgss;'${NC}"
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE EXTENSION pg_stat_kcache SCHEMA pgsk;'${NC}"
echo -e "${CYAN}psql -X -U postgres -d postgres -c 'CREATE EXTENSION pg_wait_sampling SCHEMA pgws;'${NC}"
